...
import { S as SafeIcon, b as dashboardApi, B as Button, p as pangkalanApi, c as activityApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
import { B as Badge, D as Dialog, i as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, j as Skeleton, S as Separator, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
import { useState, useEffect, useRef } from "react";
import { ResponsiveContainer, AreaChart, CartesianGrid, XAxis, YAxis, Tooltip, Area, Legend, BarChart, Bar, Cell, PieChart, Pie } from "recharts";
...
function AnimatedNumber({
  ...
  return /* @__PURE__ */ jsx("span", { className: `kpi-number animate-countUp ${className}`, style: { animationDelay: `${delay}ms` }, children: isCurrency ? formatCurrency(animatedValue) : formatNumber(animatedValue) });
}
...
function DSSAlertSection() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 animate-fadeInUp", style: { animationDelay: "0.15s" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-xl sm:text-2xl font-bold tracking-tight text-foreground flex items-center gap-2", children: [
            ...
            hasAlerts && /* @__PURE__ */ jsxs(Badge, { variant: "destructive", className: "animate-pulse text-xs", children: [
              data.lowStockAlerts.length + data.paymentOverdueAlerts.length,
              " alerts"
            ] })
          ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsx(HealthScoreRing, { score: data.summary.overallHealthScore }) }),
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
        /* @__PURE__ */ jsx(
          StatCard,
          {
            label: "Pending",
...
const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-background border border-border rounded-lg shadow-lg p-4 backdrop-blur-sm min-w-[200px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2 pb-2 border-b", children: [
        /* @__PURE__ */ jsx("span", { className: `text-xs px-2 py-0.5 rounded-full font-medium ${rankBadge.color}`, children: rankBadge.text }),
        /* @__PURE__ */ jsxs("span", { className: "text-sm font-bold text-primary", children: [
          data.percentage,
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-foreground mb-2 truncate max-w-[180px]", title: data.name, children: data.name }),
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: "Total Pesanan:" }),
...
function PangkalanOrderChart({ isVisible = true }) {
  ...
  const handleOpenModal = async () => {
    ...
    if (allRankings.length === 0) {
      ...
      try {
        ...
        const sorted = response.data.filter((p) => p._count?.orders > 0).map((p) => ({
          name: p.name,
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "animate-pulse text-muted-foreground text-sm", children: "Memuat data..." }) });
  }
  if (error) {
    return /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "text-destructive text-sm", children: error }) });
  }
  if (data.length === 0) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full h-full flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5 pt-2 pb-2", children: data.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("span", { className: "flex-1 truncate text-muted-foreground", title: item.name, children: item.name }),
      /* @__PURE__ */ jsxs("span", { className: "font-semibold text-foreground shrink-0", children: [
        item.percentage,
        "%"
      ] })
    ] }, item.name)) }),
    /* @__PURE__ */ jsxs(Dialog, { open: showModal, onOpenChange: setShowModal, children: [
      /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "BarChart3", className: "h-3.5 w-3.5 mr-1.5" }),
            "Lihat Semua Ranking"
          ]
        }
      ) }),
      /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-md max-h-[80vh]", children: [
        /* @__PURE__ */ jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsx(DialogTitle, { children: "Ranking Semua Pangkalan" }),
          /* @__PURE__ */ jsx(DialogDescription, { children: "Berdasarkan jumlah pesanan" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "overflow-y-auto max-h-[50vh] pr-2", children: isLoadingMore ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Loader2", className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : allRankings.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-2", children: allRankings.map((item, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: "flex items-center gap-3 p-2 rounded-lg hover:bg-muted/50 transition-colors",
            children: [
              /* @__PURE__ */ jsx("div", { className: `w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${index === 0 ? "bg-yellow-500 text-white" : index === 1 ? "bg-gray-400 text-white" : index === 2 ? "bg-amber-600 text-white" : "bg-muted text-muted-foreground"}`, children: index + 1 }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "text-sm font-semibold text-primary shrink-0", children: [
                item.percentage,
                "%"
              ] })
            ]
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "h-full flex flex-col chart-card-premium border-0", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4 flex-1 flex flex-col pt-4", children: [
      /* @__PURE__ */ jsx("div", { className: "space-y-3 max-h-96 overflow-y-auto flex-1", children: isLoading ? (
        ...
        // Empty state
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-8 text-muted-foreground", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Inbox", className: "h-10 w-10 mb-2 opacity-50" }),
...
function DashboardContent() {
  return /* @__PURE__ */ jsxs("div", { id: "is6jwg", className: "relative flex-1 space-y-8 p-4 sm:p-6 lg:p-8 mesh-gradient-bg min-h-screen overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 grid grid-cols-1 gap-6 md:grid-cols-2", children: [
      /* @__PURE__ */ jsx(ChartContainer, { animationDelay: "0.6s", children: (isVisible) => /* @__PURE__ */ jsx("div", { className: "animate-fadeInUp chart-stock", style: { animationDelay: "0.4s" }, children: /* @__PURE__ */ jsxs(Card, { className: "chart-card-premium border-0", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "p-4 sm:p-6 pt-4", children: /* @__PURE__ */ jsx("div", { className: "w-full h-64 sm:h-72", children: /* @__PURE__ */ jsx(StockChart, { isVisible }) }) })
      ] }) }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx(ChartContainer, { animationDelay: "0.7s", children: (isVisible) => /* @__PURE__ */ jsx("div", { className: "animate-fadeInUp h-full", style: { animationDelay: "0.5s" }, children: /* @__PURE__ */ jsxs(Card, { className: "h-full chart-card-premium border-0 flex flex-col", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3 border-b border-border/50", children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { className: "text-xs sm:text-sm", children: "3 pangkalan dengan order terbanyak" })
        ] }),
...
const $$DashboardAdmin = createComponent(($$result, $$props, $$slots) => renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { title: "Dashboard Admin - SIM4LON" }, { default: ($$result2) => renderTemplate`
  ...
  ${renderComponent($$result2, "ProtectedDashboard", ProtectedDashboard, { "client:load": true, allowedRoles: ["ADMIN", "OPERATOR"], "client:component-hydration": "load", "client:component-path": "@/components/auth/ProtectedDashboard.tsx", "client:component-export": "default" }, { default: ($$result3) => renderTemplate`
    ...
    ` })}
  ` })}
` })}`, "E:/DATA/Ngoding/sim4lon/src/pages/dashboard-admin.astro", void 0);
const $$file = "E:/DATA/Ngoding/sim4lon/src/pages/dashboard-admin.astro";
const $$url = "/dashboard-admin.html";
