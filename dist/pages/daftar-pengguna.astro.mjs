    ...
    /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs(Select, { value: formData.role, onValueChange: handleRoleChange, disabled: isLoading, children: [
          ...
          /* @__PURE__ */ jsx(SelectContent, { children: roleOptions$1.map((option) => /* @__PURE__ */ jsx(SelectItem, { value: option.value, children: option.label }, option.value)) })
        ] }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-4 sm:p-6 lg:p-8 dashboard-gradient-bg min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx(Card, { className: "glass-card overflow-hidden", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: sortedUserList.length > 0 ? sortedUserList.map((user) => {
            ...
            TableRow,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsx(
                  Badge,
                  {
                    className: user.is_active ? "bg-gradient-to-r from-emerald-600/90 to-emerald-500/90 text-white shadow-sm" : "bg-gradient-to-r from-muted-foreground/60 to-muted-foreground/50 text-white shadow-sm",
        ...
        }) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 7, className: "text-center py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg font-semibold text-muted-foreground", children: "Tidak ada pengguna ditemukan" }),
