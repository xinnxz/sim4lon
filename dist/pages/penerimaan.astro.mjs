...
import { B as Button, S as SafeIcon, I as Input, g as penerimaanApi, l as lpgProductsApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
...
import { c as createFooterRow, a as exportToExcel } from "../_astro/export-utils.JoWvmrkT.js";
...
function PenerimaanPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsx(Card, { className: "glass-card", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: fetchData, disabled: isLoading, children: [
        /* @__PURE__ */ jsx(SafeIcon, { name: "RefreshCw", className: `w-4 h-4 mr-2 ${isLoading ? "animate-spin" : ""}` }),
        "Refresh"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex-1" }),
      /* @__PURE__ */ jsxs(Button, { onClick: () => setShowAddModal(true), className: "gap-2 bg-gradient-to-r from-primary to-primary/80", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: "chart-card-premium", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "border-b border-border/50 pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsx(CardTitle, { className: "text-lg font-semibold", children: "Rekapitulasi Penerimaan" }),
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
          ...
          ] }) }) : data?.data.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "text-center py-8 text-muted-foreground", children: "Tidak ada data penerimaan untuk bulan ini" }) }) : sortedData.map((item) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-border/30 hover:bg-muted/30 transition-colors", children: [
