...
import { S as SafeIcon, B as Button, o as ordersApi, d as driversApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "../_astro/card.OLhQVURm.js";
import { S as Separator, B as Badge, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, A as Avatar, l as AvatarFallback, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell, f as TableFooter } from "../_astro/table.CfABLaOl.js";
import { f as formatCurrency } from "../_astro/currency._AzJKMQz.js";
...
function OrderSummaryCard({ order }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Ringkasan Pesanan" }) }),
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Tanggal Pesanan" }),
      ...
      /* @__PURE__ */ jsx(Separator, {}),
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 px-1", children: [
        ...
        order.tax > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground flex items-center gap-2", children: [
            "PPN 12%",
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "text-[10px] px-1.5 py-0 bg-orange-50 text-orange-600 border-orange-200", children: "Non-Subsidi" })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center bg-primary/10 p-4 rounded-lg border border-primary/20", children: [
        /* @__PURE__ */ jsx("span", { className: "font-bold text-base", children: "Total" }),
        /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-primary", children: formatCurrency(order.total) })
      ] })
    ] })
  ] });
}
...
function OrderActionsPanel({
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3", children: [
      ...
      isDriverAssigned && !isCompleted && /* @__PURE__ */ jsxs(
        Button,
        {
...
function CustomerInfoCard({ customer }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Informasi Pangkalan" }) }),
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm", children: customer.address })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Mail", className: "h-4 w-4" }),
              customer.email
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxs("div", { className: "border-t pt-4", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Kontak Penanggung Jawab" }),
        /* @__PURE__ */ jsx("p", { className: "font-medium text-sm", children: customer.contact }),
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Phone", className: "h-4 w-4" }),
...
function DeliveryInfoCard({ delivery }) {
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Informasi Pengiriman" }) }),
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Status Pengiriman" }),
        /* @__PURE__ */ jsx(
          Badge,
          {
            variant: "status",
            className: `mt-1 ${delivery.status === "not_scheduled" || delivery.status === "ready_to_ship" ? "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300" : delivery.status === "scheduled" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300" : delivery.status === "in_delivery" || delivery.status === "assigned" ? "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300" : "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300"}`,
            children: delivery.statusLabel
          }
        )
      ] }),
      delivery.driver ? /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Driver" }),
        /* @__PURE__ */ jsx("p", { className: "font-medium", children: delivery.driver }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Driver" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground italic", children: "Belum ditugaskan" })
      ] }),
      delivery.estimatedDate ? /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Tanggal Estimasi" }),
        /* @__PURE__ */ jsx("p", { className: "font-medium", children: delivery.estimatedDate })
      ] }) : null,
      /* @__PURE__ */ jsxs("div", { className: "bg-secondary/50 p-3 rounded-lg", children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground font-medium mb-1", children: "Catatan" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm", children: delivery.notes })
      ] })
    ] })
  ] });
}
...
function OrderDetailContent() {
  ...
  if (!order) {
    return /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center justify-center p-6 gap-4", children: [
      /* @__PURE__ */ jsx(SafeIcon, { name: "AlertCircle", className: "h-16 w-16 text-destructive" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold", children: "Detail Pesanan" }),
          /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground font-mono", children: [
            "ID: ",
            order.id
          ] })
        ] })
