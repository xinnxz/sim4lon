...
import { S as SafeIcon, I as Input, B as Button, q as expensesApi } from "../../_astro/AuthGuard.Cq_0lvUi.js";
...
function PengeluaranPage() {
  ...
  const getCategoryGradient = (cat) => CATEGORIES.find((c) => c.value === cat)?.gradient || "from-gray-500 to-gray-600";
  const getCategoryIcon = (cat) => CATEGORIES.find((c) => c.value === cat)?.icon || "Circle";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 pb-8", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: "bg-white shadow-lg rounded-2xl border-0 overflow-hidden", children: [
      ...
      ] }) : /* @__PURE__ */ jsx("div", { className: "divide-y divide-slate-100", children: expenses.map((expense, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: `w-12 h-12 rounded-xl bg-gradient-to-br ${getCategoryGradient(expense.category)} flex items-center justify-center`, children: /* @__PURE__ */ jsx(SafeIcon, { name: getCategoryIcon(expense.category), className: "h-6 w-6 text-white" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-semibold text-slate-900", children: getCategoryLabel(expense.category) }),
                  /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "text-xs", children: formatDate(expense.expense_date) })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500 mt-1", children: expense.description || "Tidak ada keterangan" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxs("span", { className: "font-bold text-red-600 text-lg", children: [
                "-",
