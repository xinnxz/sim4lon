...
import { S as SafeIcon, B as Button, e as authApi, m as consumerOrdersApi, n as pangkalanStockApi, q as expensesApi, s as lpgPricesApi } from "../../_astro/AuthGuard.Cq_0lvUi.js";
  ...
  if (active && payload && payload.length) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-white px-4 py-3 rounded-xl shadow-2xl border border-slate-200 min-w-[160px]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex justify-between items-center", children: /* @__PURE__ */ jsxs("span", { className: "text-lg font-bold text-slate-800", children: [
          data.value,
          " tabung"
        ] }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center pt-1 border-t border-slate-100 mt-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 animate-fadeInDown", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white tracking-tight", children: "Dashboard" }),
          /* @__PURE__ */ jsxs("p", { className: "text-slate-500 dark:text-slate-400 mt-1 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Sparkles", className: "h-4 w-4 text-amber-500 animate-pulse" }),
            "Selamat datang, ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxs(Card, { className: "bg-white shadow-lg rounded-2xl border-0 overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: expenseSummary.byCategory.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Wallet", className: "h-12 w-12 text-slate-300 mx-auto mb-3" }),
      ...
      /* @__PURE__ */ jsxs(Card, { className: "bg-white shadow-lg rounded-2xl border-0 overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3 pt-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-blue-50 border border-blue-100", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-blue-600", children: formatCurrency(stats?.total_revenue || 0) })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-green-600", children: formatCurrency(stats?.laba_bersih || 0) })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(Card, { className: "bg-white shadow-lg rounded-2xl border-0 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: recentSales.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "h-5 w-5 text-blue-600" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
