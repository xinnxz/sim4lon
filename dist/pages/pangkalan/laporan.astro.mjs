...
import { S as SafeIcon, B as Button, q as consumerOrdersApi, v as lpgPricesApi, t as expensesApi, f as authApi } from "../../_astro/AuthGuard.71S_I7hh.js";
import { e as DropdownMenu, f as DropdownMenuTrigger, g as DropdownMenuContent, h as DropdownMenuItem, B as Badge, P as ProtectedDashboard } from "../../_astro/ProtectedDashboard.TvdlGC6x.js";
...
function LaporanPangkalanPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 pb-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 animate-fadeInDown", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "h-10 sm:h-12 w-1.5 rounded-full bg-gradient-to-b from-blue-500 via-indigo-500 to-purple-500 animate-lineGrow" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white tracking-tight", children: "Laporan Penjualan" }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5 sm:mt-1 flex items-center gap-1 sm:gap-2", children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Calculator", className: "h-3 w-3 sm:h-4 sm:w-4 animate-pulse" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center bg-slate-100 rounded-xl p-1 gap-1 overflow-x-auto max-w-full", children: [
          [
            ...
            "button",
            {
              ...
              className: `flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all whitespace-nowrap shrink-0 ${selectedPeriod === period.value && !showCustom ? "bg-white shadow-sm text-blue-600" : "text-slate-600 hover:text-slate-900"}`,
              children: [
                /* @__PURE__ */ jsx(SafeIcon, { name: period.icon, className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: `flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all whitespace-nowrap shrink-0 ${showCustom ? "bg-white shadow-sm text-blue-600" : "text-slate-600 hover:text-slate-900"}`,
              children: [
                /* @__PURE__ */ jsx(SafeIcon, { name: "Settings2", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
                /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Custom" }),
                /* @__PURE__ */ jsx("span", { className: "sm:hidden", children: "Cust" })
              ]
            }
          )
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "hidden sm:block relative overflow-hidden bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl border border-slate-200 p-3 sm:p-4 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-white text-[10px] sm:text-xs", children: "Modal = Qty × Harga Beli" }),
        /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "→" }),
        /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-white text-[10px] sm:text-xs", children: "Penjualan = Qty × Harga Jual" }),
        /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "→" }),
        /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "bg-green-50 text-green-700 border-green-200 text-[10px] sm:text-xs", children: "Laba = Penjualan - Modal" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid gap-4 grid-cols-2 lg:grid-cols-5", children: [
        /* @__PURE__ */ jsx("div", { className: "animate-slideInBlur stagger-1", style: { opacity: 0 }, children: /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group h-full", children: [
          ...
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-1 sm:pb-2 relative", children: /* @__PURE__ */ jsxs(CardTitle, { className: "text-xs sm:text-sm font-medium opacity-90 flex items-center gap-1.5 sm:gap-2", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "relative pt-0 sm:pt-2", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight", children: formatCurrency(totals.penjualan) }),
            /* @__PURE__ */ jsxs("p", { className: "text-blue-100 text-xs sm:text-sm mt-1 sm:mt-2 flex items-center gap-1", children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "h-3 w-3 sm:h-3.5 sm:w-3.5" }),
              totals.qty,
              " tabung terjual"
            ] })
          ] })
        ...
        /* @__PURE__ */ jsx("div", { className: "animate-slideInBlur stagger-2", style: { opacity: 0 }, children: /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-slate-600 to-slate-700 text-white shadow-lg shadow-slate-500/20 hover:shadow-xl hover:shadow-slate-500/30 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group h-full", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-24 h-24 bg-white/15 rounded-full -translate-y-1/2 translate-x-1/2 animate-floatOrb" }),
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-1 sm:pb-2 relative", children: /* @__PURE__ */ jsxs(CardTitle, { className: "text-xs sm:text-sm font-medium opacity-90 flex items-center gap-1.5 sm:gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 sm:p-1.5 rounded-lg bg-white/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Wallet", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
            "Total Beli"
          ] }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "relative pt-0 sm:pt-2", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight", children: formatCurrency(totals.modal) }),
            /* @__PURE__ */ jsx("p", { className: "text-slate-300 text-xs sm:text-sm mt-1 sm:mt-2", children: "Biaya pembelian LPG" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "animate-slideInBlur stagger-3", style: { opacity: 0 }, children: /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-cyan-500 to-teal-600 text-white shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-500/30 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group h-full", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-24 h-24 bg-white/15 rounded-full -translate-y-1/2 translate-x-1/2 animate-floatOrb" }),
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-1 sm:pb-2 relative", children: /* @__PURE__ */ jsxs(CardTitle, { className: "text-xs sm:text-sm font-medium opacity-90 flex items-center gap-1.5 sm:gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 sm:p-1.5 rounded-lg bg-white/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ArrowUpRight", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
            "Margin Kotor"
          ] }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "relative pt-0 sm:pt-2", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight", children: formatCurrency(marginKotor) }),
            /* @__PURE__ */ jsx("p", { className: "text-cyan-100 text-xs sm:text-sm mt-1 sm:mt-2", children: "Sebelum pengeluaran" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "animate-slideInBlur stagger-4", style: { opacity: 0 }, children: /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-500 text-white shadow-lg shadow-orange-500/20 hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group h-full", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-12 h-12 bg-white/10 rounded-full translate-y-1/2 -translate-x-1/2 animate-floatOrb-delayed" }),
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-1 sm:pb-2 relative", children: /* @__PURE__ */ jsxs(CardTitle, { className: "text-xs sm:text-sm font-medium opacity-90 flex items-center gap-1.5 sm:gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 sm:p-1.5 rounded-lg bg-white/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12", children: /* @__PURE__ */ jsx(SafeIcon, { name: "MinusCircle", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
            "Pengeluaran"
          ] }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "relative pt-0 sm:pt-2", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight", children: formatCurrency(totals.pengeluaran) }),
            /* @__PURE__ */ jsx("p", { className: "text-orange-100 text-xs sm:text-sm mt-1 sm:mt-2", children: "Biaya operasional" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "animate-slideInBlur stagger-5", style: { opacity: 0 }, children: /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group h-full", children: [
          ...
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-1 sm:pb-2 relative", children: /* @__PURE__ */ jsxs(CardTitle, { className: "text-xs sm:text-sm font-medium opacity-90 flex items-center gap-1.5 sm:gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "p-1 sm:p-1.5 rounded-lg bg-white/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12", children: /* @__PURE__ */ jsx(SafeIcon, { name: "BadgeDollarSign", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
            "Laba Bersih"
          ] }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "relative pt-0 sm:pt-2", children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight", children: formatCurrency(totals.laba) }),
            /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 mt-1 sm:mt-2", children: /* @__PURE__ */ jsxs(Badge, { className: "bg-white/20 text-white hover:bg-white/30 text-[10px] sm:text-xs", children: [
              marginPercentage,
              "% margin"
            ] }) })
          ] })
