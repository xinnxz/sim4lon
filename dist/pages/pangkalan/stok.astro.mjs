...
import { S as SafeIcon, B as Button, I as Input, l as lpgProductsApi, v as agenOrdersApi, e as authApi, n as pangkalanStockApi, s as lpgPricesApi, k as companyProfileApi } from "../../_astro/AuthGuard.Cq_0lvUi.js";
import { B as Badge, e as DropdownMenu, f as DropdownMenuTrigger, g as DropdownMenuContent, h as DropdownMenuItem, D as Dialog, i as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, k as DialogFooter, P as ProtectedDashboard } from "../../_astro/ProtectedDashboard.DWDsm_1Q.js";
  ...
  const handleReceiveStock = async () => {
    ...
    try {
      ...
      await pangkalanStockApi.receiveStock({
        ...
        qty: receiveData.movementType === "OUT" ? -receiveData.qty : receiveData.qty,
        // Negatif untuk keluar
      ...
      setReceiveData({ lpgType: "kg3", qty: 0, note: "", movementType: "IN" });
      fetchData();
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 pb-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              children: [
                ...
                "Pesan ke Agen",
                agenOrders.filter((o) => o.status === "PENDING" || o.status === "DIKIRIM").length > 0 && /* @__PURE__ */ jsx("span", { className: "absolute -top-2 -right-2 w-5 h-5 bg-orange-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg animate-pulse", children: agenOrders.filter((o) => o.status === "PENDING" || o.status === "DIKIRIM").length })
              ]
            }
          ) }),
        ...
        /* @__PURE__ */ jsxs(Dialog, { open: isReceiveOpen, onOpenChange: setIsReceiveOpen, children: [
          /* @__PURE__ */ jsx(DialogTrigger, { asChild: true }),
          /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md", children: [
            /* @__PURE__ */ jsxs(DialogHeader, { children: [
              /* @__PURE__ */ jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-green-100 flex items-center justify-center", children: /* @__PURE__ */ jsx(SafeIcon, { name: "PackagePlus", className: "h-5 w-5 text-green-600" }) }),
                "Koreksi Stok Manual"
              ] }),
              /* @__PURE__ */ jsx(DialogDescription, { children: "Catat penyesuaian stok (selisih opname atau sumber lain)" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4 py-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-sm font-medium", children: "Jenis Koreksi" }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                  /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      className: `flex items-center justify-center gap-2 p-3 rounded-xl border-2 transition-all ${receiveData.movementType === "IN" ? "border-green-500 bg-green-50 text-green-700" : "border-slate-200 hover:border-slate-300"}`,
                      children: [
                        /* @__PURE__ */ jsx(SafeIcon, { name: "Plus", className: "h-4 w-4" }),
                        /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Tambah" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      className: `flex items-center justify-center gap-2 p-3 rounded-xl border-2 transition-all ${receiveData.movementType === "OUT" ? "border-red-500 bg-red-50 text-red-700" : "border-slate-200 hover:border-slate-300"}`,
                      children: [
                        /* @__PURE__ */ jsx(SafeIcon, { name: "Minus", className: "h-4 w-4" }),
                        /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Kurangi" })
                      ]
                    }
                  )
                ] })
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-sm font-medium", children: "Tipe LPG" }),
                /* @__PURE__ */ jsxs(Select, { value: receiveData.lpgType, onValueChange: (v) => setReceiveData({ ...receiveData, lpgType: v }), children: [
                  /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsx(SelectContent, { children: activeLpgTypes.map((type) => /* @__PURE__ */ jsx(SelectItem, { value: type.value, children: type.label }, type.value)) })
                ] })
              ] }),
            ...
            /* @__PURE__ */ jsxs(DialogFooter, { children: [
              /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => setIsReceiveOpen(false), children: "Batal" }),
              /* @__PURE__ */ jsxs(Button, { onClick: handleReceiveStock, disabled: isSubmitting, className: "bg-green-600 hover:bg-green-700", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/20", children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-6 relative", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "h-10 w-10" }) })
      ] }) })
    ] }),
    ...
    activeTab === "stock" ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "grid gap-4 grid-cols-2 lg:grid-cols-4", children: stocks.filter((stock) => {
        ...
        return /* @__PURE__ */ jsxs(Card, { className: "relative overflow-hidden bg-white shadow-lg border-0 hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-16 h-16 bg-slate-100 rounded-full -translate-y-1/2 translate-x-1/2" }),
          /* @__PURE__ */ jsx(CardHeader, { className: "pb-2 relative", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("div", { className: `w-12 h-12 rounded-xl bg-gradient-to-br ${config.gradient} flex items-center justify-center shadow-lg`, children: /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "h-6 w-6 text-white" }) }),
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: status.color, children: status.label })
          ] }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "relative", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500 mb-1", children: config.name }),
            /* @__PURE__ */ jsxs("p", { className: "text-3xl font-bold text-slate-900", children: [
              stock.qty,
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "h-2 bg-slate-100 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsx(SafeIcon, { name: "PackagePlus", className: "h-6 w-6 text-green-600" }) }),
                /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-semibold text-slate-900", children: "Koreksi Stok" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500", children: "Penyesuaian manual (opname)" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ClipboardCheck", className: "h-6 w-6 text-slate-600" }) }),
                /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-semibold text-slate-900", children: "Stock Opname" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500", children: "Sesuaikan stok aktual" })
                ] })
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsx(Card, { className: "bg-white shadow-lg rounded-2xl border-0", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxs(Select, { value: filterType, onValueChange: setFilterType, children: [
            /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[180px] rounded-xl", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Semua Tipe" }) }),
          ...
          /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", onClick: fetchMovements, className: "rounded-xl ml-auto", children: [
        ...
        /* @__PURE__ */ jsx(Card, { className: "bg-white shadow-lg rounded-2xl border-0 overflow-hidden", children: /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: isLoadingHistory ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-16", children: /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-2 border-blue-200 border-t-blue-600" }) }) : movements.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-slate-500", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-full bg-slate-100 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Inbox", className: "h-8 w-8 text-slate-300" }) }),
          ...
          totalPages > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-t bg-slate-50", children: [
