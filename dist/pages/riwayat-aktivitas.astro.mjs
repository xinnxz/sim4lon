...
import { e as cn, C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "../_astro/card.OLhQVURm.js";
import { B as Badge, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
import { S as SafeIcon, B as Button, c as activityApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
    ...
    /* @__PURE__ */ jsxs(Card, { className: "glass-card overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
        isLoading ? /* @__PURE__ */ jsx(TimelineSkeleton, {}) : error ? (
          ...
          // Empty State
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "h-24 w-24 rounded-full bg-gradient-to-br from-primary/10 to-primary/20 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Inbox", className: "h-12 w-12 text-primary/60" }) }),
