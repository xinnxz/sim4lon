...
import { e as cn, C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "../_astro/card.OLhQVURm.js";
import { z as buttonVariants, S as SafeIcon, B as Button, I as Input, l as lpgProductsApi, C as perencanaanApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "../_astro/select.DOfMR1sZ.js";
import { e as DropdownMenu, f as DropdownMenuTrigger, g as DropdownMenuContent, h as DropdownMenuItem, B as Badge, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, k as DialogFooter, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs(Tabs, { value: activeTab, onValueChange: handleTabChange, children: [
      /* @__PURE__ */ jsxs(TabsList, { className: "glass-card p-1 mb-4", children: [
        /* @__PURE__ */ jsxs(TabsTrigger, { value: "rekapitulasi", className: "data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-cyan-500 data-[state=active]:text-white", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Table", className: "w-4 h-4 mr-2" }),
          "Rekapitulasi"
        ] }),
        /* @__PURE__ */ jsxs(TabsTrigger, { value: "form", className: "data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-cyan-500 data-[state=active]:text-white", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Edit", className: "w-4 h-4 mr-2" }),
          "Input Form"
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-4", children: lpgTypeOptions.map((opt) => /* @__PURE__ */ jsxs(
        Button,
        {
          variant: selectedLpgType === opt.value ? "default" : "outline",
          size: "sm",
          className: selectedLpgType === opt.value ? "bg-gradient-to-r from-emerald-500 to-teal-500 text-white border-0" : "hover:bg-emerald-50 dark:hover:bg-emerald-900/20",
          ...
          /* @__PURE__ */ jsxs(AlertDialog, { open: showGenerateDialog, onOpenChange: setShowGenerateDialog, children: [
            /* @__PURE__ */ jsx(AlertDialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(SafeIcon, { name: "Wand2", className: `w-4 h-4 mr-1 ${isGenerating ? "animate-spin" : ""}` }),
                  /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: isGenerating ? "Generating..." : "Generate Otomatis" }),
                  /* @__PURE__ */ jsx("span", { className: "sm:hidden", children: isGenerating ? "..." : "Generate" })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxs(AlertDialogContent, { className: "mx-4 max-w-[calc(100vw-2rem)] sm:max-w-lg", children: [
      ...
      /* @__PURE__ */ jsxs(TabsContent, { value: "rekapitulasi", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6", children: [
          ...
          /* @__PURE__ */ jsx(Card, { className: "glass-card", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Realisasi" }),
          ...
          /* @__PURE__ */ jsx(Card, { className: `glass-card ${summaryStats.overAlokasi > 0 ? "border-red-500/50 bg-red-500/5" : summaryStats.nearLimit > 0 ? "border-yellow-500/50 bg-yellow-500/5" : ""}`, children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: `p-2 rounded-xl ${summaryStats.overAlokasi > 0 ? "bg-red-500/20" : "bg-yellow-500/10"}`, children: /* @__PURE__ */ jsx(SafeIcon, { name: "AlertTriangle", className: `w-5 h-5 ${summaryStats.overAlokasi > 0 ? "text-red-500" : "text-yellow-500"}` }) }),
            /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "chart-card-premium", children: [
          /* @__PURE__ */ jsx(CardHeader, { className: "border-b border-border/50 pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsx(CardTitle, { className: "text-lg font-semibold", children: "Rekapitulasi Perencanaan" }),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
                ...
                /* @__PURE__ */ jsx("tbody", { children: isLoading ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: dayHeaders.length + 8, className: "text-center py-8", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-center font-medium", children: row.alokasi.toLocaleString() }),
                  dayHeaders.map((dayInfo) => {
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "form", children: /* @__PURE__ */ jsxs(Card, { className: "chart-card-premium", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: !rekapData || rekapData.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "AlertCircle", className: "w-12 h-12 mx-auto mb-4 opacity-50" }),
