...
import { S as SafeIcon, B as Button, g as penerimaanApi } from "../_astro/AuthGuard.71S_I7hh.js";
...
${dayName}`;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4", children: [
      /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "glass-card h-full", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "p-1.5 sm:p-2 rounded-xl bg-blue-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "PackagePlus", className: "w-4 h-4 sm:w-5 sm:h-5 text-blue-500" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground", children: "Stok Awal" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: data?.stok_awal_bulan || 0, delay: 100 }) })
        ] })
      ] }) }) }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "glass-card h-full", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "p-1.5 sm:p-2 rounded-xl bg-green-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ArrowDownCircle", className: "w-4 h-4 sm:w-5 sm:h-5 text-green-500" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground", children: "Penerimaan" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-green-600", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: data?.total_penerimaan || 0, delay: 200 }) })
        ] })
      ] }) }) }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "glass-card h-full", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "p-1.5 sm:p-2 rounded-xl bg-orange-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ArrowUpCircle", className: "w-4 h-4 sm:w-5 sm:h-5 text-orange-500" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground", children: "Penyaluran" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-orange-600", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: data?.total_penyaluran || 0, delay: 300 }) })
        ] })
      ] }) }) }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "glass-card h-full", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "p-1.5 sm:p-2 rounded-xl bg-purple-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "PackageOpen", className: "w-4 h-4 sm:w-5 sm:h-5 text-purple-500" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground", children: "Stok Akhir" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-purple-600", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: data?.stok_akhir_bulan || 0, delay: 400 }) })
        ] })
      ] }) }) }) })
    ] }),
    /* @__PURE__ */ jsx(Card, { className: "glass-card", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-2 sm:gap-3", children: [
      /* @__PURE__ */ jsxs(Select, { value: selectedMonth, onValueChange: setSelectedMonth, children: [
        /* @__PURE__ */ jsx(SelectTrigger, { className: "w-full sm:w-44 h-10 sm:h-9", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:flex gap-2 sm:ml-auto", children: [
        ...
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "h-10 sm:h-9", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Download", className: "w-4 h-4 mr-1" }),
            /* @__PURE__ */ jsx("span", { className: "text-xs sm:text-sm", children: "Download" }),
    ...
    /* @__PURE__ */ jsxs(Card, { className: "chart-card-premium overflow-hidden", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "border-b border-border/50 pb-3 sm:pb-4 px-3 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        ...
        /* @__PURE__ */ jsx(CardTitle, { className: "text-sm sm:text-lg font-semibold", children: "In Out Agen" }),
      ...
      /* @__PURE__ */ jsx(CardContent, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("table", { className: "w-full text-[10px] sm:text-xs lg:text-sm min-w-[600px]", children: [
