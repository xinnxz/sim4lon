...
import { S as SafeIcon, l as lpgProductsApi, c as dashboardApi, B as Button, I as Input } from "../_astro/AuthGuard.71S_I7hh.js";
import { C as Card, b as CardHeader, a as CardContent, d as CardTitle, e as CardDescription } from "../_astro/card.CnUj7wdc.js";
import { B as Badge, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.TvdlGC6x.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    showSummary && /* @__PURE__ */ jsx("div", { className: "glass-card rounded-2xl overflow-hidden animate-fadeInUp", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center md:justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-xl overflow-hidden shadow-lg bg-gradient-to-br from-primary/10 to-accent/10", children: /* @__PURE__ */ jsx("img", { src: "/images/icons/stock-icon.png", alt: "Stok", className: "w-full h-full object-contain" }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: products.map((product, index) => {
      ...
      const colorHex = getColorHex$1(product.color);
      return /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs(
            Card,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(CardContent, { className: "flex-1 flex flex-col p-4", children: [
                  /* @__PURE__ */ jsx("div", { className: "flex justify-center py-2", children: /* @__PURE__ */ jsxs(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "text-center mb-3", children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-semibold text-sm text-foreground leading-snug line-clamp-2 min-h-[2.5rem]", children: product.name }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "text-center mb-3", children: [
                    /* @__PURE__ */ jsx(
                      "span",
                      {
                        ...
                        style: { color: product.stock.current >= 0 ? colorHex : void 0 },
                        children: /* @__PURE__ */ jsx(AnimatedNumber, { value: product.stock.current, delay: 300 + index * 50 })
                      }
                    ),
                    /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground ml-1", children: "unit" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center gap-2 mb-2", children: [
                    /* @__PURE__ */ jsx(
                      Badge,
                      {
                        variant: "outline",
                        className: `text-[10px] px-1.5 py-0.5 font-medium ${product.category === "SUBSIDI" ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400" : "bg-blue-50 text-blue-600 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400"}`,
                        children: getCategoryLabel(product.category)
                      }
                    ),
                    displayPrice > 0 && /* @__PURE__ */ jsx("span", { className: "font-semibold text-sm text-foreground", children: formatPrice(Number(displayPrice)) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center pt-2 mt-auto border-t border-border/40", children: [
                    getStatusBadge(status),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-[10px] text-muted-foreground/60", children: [
                      /* @__PURE__ */ jsx(SafeIcon, { name: "Lock", className: "h-2.5 w-2.5" }),
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "overflow-hidden glass-card hover:shadow-xl transition-shadow duration-300", children: [
    ...
    /* @__PURE__ */ jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("img", { src: "/images/icons/chart-icon.png", alt: "Chart", className: "w-10 h-10 rounded-xl overflow-hidden object-contain" }),
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: editingProduct?.image_url ? /* @__PURE__ */ jsx(
                  "img",
                  {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("main", { className: "flex-1 flex flex-col", children: /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-6", children: [
      isLoading ? /* @__PURE__ */ jsx(HeaderSkeleton, {}) : /* @__PURE__ */ jsx("div", { className: "rounded-2xl p-4 animate-fadeInUp border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-accent/5 shadow-lg backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col xl:flex-row xl:items-center gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 flex-1", children: [
          /* @__PURE__ */ jsx("img", { src: "/images/icons/stock-icon.png", alt: "Stok LPG", className: "w-16 h-16 rounded-xl object-contain" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
