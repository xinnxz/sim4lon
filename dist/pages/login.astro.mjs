...
import { S as SafeIcon, I as Input, B as Button, i as isAuthenticated, f as authApi, h as removeToken, j as clearCachedProfile } from "../_astro/AuthGuard.BLl0uVB7.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full px-4 sm:px-0", children: [
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 shadow-sm", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 text-sm", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "tes2@demo.com" })
                    ] })
                  ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "text-center mt-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
        /* @__PURE__ */ jsx("span", { className: "text-white/50 text-sm", children: " Website Powered by ." }),
        /* @__PURE__ */ jsx(
          "img",
          {
            src: "/logo-reonx.png",
      ...
      /* @__PURE__ */ jsx("p", { className: "text-white/50 text-sm", children: "© 2026 SIM4LON. All rights reserved." })
    ] })
  ] });
}
