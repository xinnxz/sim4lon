...
import { B as Button, S as SafeIcon, I as Input, o as ordersApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
...
import "../_astro/card.OLhQVURm.js";
...
function OrderListPage() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await ordersApi.getAll(currentPage, pageSize, status, pangkalanFilter || void 0, void 0, sortBy, sortOrder);
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    return order.id.toLowerCase().includes(term) || order.pangkalans?.name.toLowerCase().includes(term) || order.order_items?.some((item) => item.label.toLowerCase().includes(term));
  });
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-6 dashboard-gradient-bg min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-5", children: [
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-1 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Hari Ini" }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold mt-2", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: stats?.total || 0, delay: 100 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "pesanan" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingCart", className: "h-5 w-5 text-gray-600 dark:text-gray-300" }) })
        ] }),
      ...
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-2 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Menunggu Bayar" }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold mt-2 text-amber-600 dark:text-amber-400", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: stats?.menunggu_pembayaran || 0, delay: 200 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "hari ini" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-900/50 dark:to-amber-800/50", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Clock", className: "h-5 w-5 text-amber-600 dark:text-amber-400" }) })
        ] }),
      ...
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-3 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Diproses" }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold mt-2 text-blue-600 dark:text-blue-400", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: stats?.diproses || 0, delay: 300 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "hari ini" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50", children: /* @__PURE__ */ jsx(SafeIcon, { name: "RefreshCw", className: "h-5 w-5 text-blue-600 dark:text-blue-400" }) })
        ] }),
      ...
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-4 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Dikirim" }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold mt-2 text-indigo-600 dark:text-indigo-400", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: stats?.dikirim || 0, delay: 400 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "hari ini" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-indigo-900/50 dark:to-indigo-800/50", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Truck", className: "h-5 w-5 text-indigo-600 dark:text-indigo-400" }) })
        ] }),
      ...
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-5 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Selesai" }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold mt-2 text-green-600 dark:text-green-400", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: stats?.selesai || 0, delay: 500 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "hari ini" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/50 dark:to-green-800/50", children: /* @__PURE__ */ jsx(SafeIcon, { name: "CheckCircle", className: "h-5 w-5 text-green-600 dark:text-green-400" }) })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "chart-card-premium rounded-2xl overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
        isLoading ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Loader2", className: "h-8 w-8 animate-spin text-primary" }) }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs(Table, { children: [
          ...
          /* @__PURE__ */ jsx(TableBody, { children: filteredOrders.length > 0 ? filteredOrders.map((order) => /* @__PURE__ */ jsxs(TableRow, { className: "hover:bg-muted/50", children: [
            ...
            /* @__PURE__ */ jsx(TableCell, { className: "text-sm", children: getItemsSummary(order) }),
            ...
            /* @__PURE__ */ jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxs("a", { href: `/detail-pesanan?id=${order.id}`, className: "flex items-center justify-center gap-2", children: [
                  /* @__PURE__ */ jsx(SafeIcon, { name: "Eye", className: "h-4 w-4" }),
                  "Lihat"
                ] })
              }
            ) })
          ] }, order.id)) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 8, className: "text-center py-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Inbox", className: "h-8 w-8 text-muted-foreground" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Tidak ada pesanan yang ditemukan" })
          ] }) }) }) })
        ] }) }),
