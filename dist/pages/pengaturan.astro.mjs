...
import { k as companyProfileApi, S as SafeIcon, B as Button, I as Input } from "../_astro/AuthGuard.Cq_0lvUi.js";
...
import { c as clearAppSettingsCache } from "../_astro/useAppSettings.WcNHyYak.js";
    ...
    /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "sppbeNumber", className: "text-sm font-medium", children: "Nomor SPPBE/SIID" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "sppbeNumber",
...
function AppearanceSettings() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Palette", className: "h-5 w-5 text-amber-600" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Tema Aplikasi" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Pilih tampilan yang nyaman untuk mata Anda" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "grid gap-3 sm:grid-cols-3", children: themeOptions.map((option) => /* @__PURE__ */ jsxs(
        "button",
        {
            ...
            /* @__PURE__ */ jsx(
              "div",
              {
                className: `flex h-12 w-12 items-center justify-center rounded-xl transition-all duration-300
                  ${settings.theme === option.value ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary"}`,
                children: /* @__PURE__ */ jsx(SafeIcon, { name: option.icon, className: "h-6 w-6" })
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("p", { className: `font-medium ${settings.theme === option.value ? "text-primary" : "text-foreground"}`, children: option.label }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: option.description })
            ] }),
            settings.theme === option.value && /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 flex h-5 w-5 items-center justify-center rounded-full bg-primary text-primary-foreground", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Check", className: "h-3 w-3" }) })
          ]
        },
        option.value
      )) }) })
    ...
    /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Brush", className: "h-5 w-5 text-purple-600" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Warna Aksen" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Pilih warna utama untuk tombol dan elemen interaktif" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-3", children: accentColors.map((color) => /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: `w-5 h-5 rounded-full ${color.color}` }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: color.label }),
            settings.accentColor === color.value && /* @__PURE__ */ jsx(SafeIcon, { name: "Check", className: "h-4 w-4 text-primary" })
          ]
        },
        color.value
      )) }) })
    ...
    /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/20 to-cyan-500/10", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Globe", className: "h-5 w-5 text-cyan-600" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Regional" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Pengaturan bahasa dan format tanggal" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(CardContent, { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "language", className: "text-sm font-medium", children: "Bahasa" }),
          /* @__PURE__ */ jsxs(Select, { value: settings.language, onValueChange: (v) => handleChange("language", v), children: [
            /* @__PURE__ */ jsx(SelectTrigger, { id: "language", className: "h-10", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "dateFormat", className: "text-sm font-medium", children: "Format Tanggal" }),
          /* @__PURE__ */ jsxs(Select, { value: settings.dateFormat, onValueChange: (v) => handleChange("dateFormat", v), children: [
            /* @__PURE__ */ jsx(SelectTrigger, { id: "dateFormat", className: "h-10", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsx(SelectItem, { value: "DD/MM/YYYY", children: "DD/MM/YYYY (31/01/2026)" }),
              /* @__PURE__ */ jsx(SelectItem, { value: "MM/DD/YYYY", children: "MM/DD/YYYY (01/31/2026)" }),
              /* @__PURE__ */ jsx(SelectItem, { value: "YYYY-MM-DD", children: "YYYY-MM-DD (2026-01-31)" })
            ] })
          ] })
        ] })
      ] }) })
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: "border shadow-sm", children: [
      /* @__PURE__ */ jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Invoice & Harga" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Pengaturan format invoice dan perhitungan harga" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "invoicePrefix", className: "text-sm font-medium", children: "Prefix Invoice" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "invoicePrefix",
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "orderCodePrefix", className: "text-sm font-medium", children: "Prefix Kode Pesanan" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "orderCodePrefix",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Tarif PPN yang berlaku untuk penjualan" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "priceRounding", className: "text-sm font-medium", children: "Pembulatan Harga" }),
            /* @__PURE__ */ jsxs(Select, { value: settings.priceRounding, onValueChange: (v) => handleChange("priceRounding", v), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { id: "priceRounding", className: "h-10", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: "1", children: "Tidak ada pembulatan" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "100", children: "Ke Rp 100 terdekat" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "1000", children: "Ke Rp 1.000 terdekat" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl bg-muted/30 border", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsx("p", { className: "font-medium text-sm", children: "Auto-Generate Kode Pesanan" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Buat kode pesanan secara otomatis saat membuat order baru" })
          ] }),
          /* @__PURE__ */ jsx(
            Switch,
            {
