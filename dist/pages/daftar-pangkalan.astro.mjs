...
import { S as SafeIcon, I as Input, B as Button, p as pangkalanApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
...
import { B as Badge, e as DropdownMenu, f as DropdownMenuTrigger, g as DropdownMenuContent, h as DropdownMenuItem, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
...
import { g as getKecamatanByKabupaten, F as Form, a as FormField, b as FormItem, c as FormLabel, d as FormControl, e as FormDescription, f as FormMessage, K as KABUPATEN_DATA } from "../_astro/regions.cq97tO2n.js";
...
function TambahPangkalanForm({ onSuccess, isModal = false }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: isModal ? "" : "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: isModal ? "border-0 shadow-none" : "shadow-card", children: [
      /* @__PURE__ */ jsxs(CardHeader, { className: isModal ? "px-0 pt-0" : "", children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Informasi Pangkalan" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Isi semua field yang diperlukan untuk mendaftarkan pangkalan baru" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { className: isModal ? "px-0" : "", children: /* @__PURE__ */ jsx(Form, { ...form, children: /* @__PURE__ */ jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-6", children: [
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Nama resmi pangkalan LPG" }),
        ...
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Nama penanggung jawab pangkalan" }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            name: "phone",
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Nomor Telepon *" }),
              /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                Input,
                {
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Nomor telepon yang dapat dihubungi" }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            name: "capacity",
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Kapasitas (Opsional)" }),
              /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                Input,
                {
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Kapasitas penyimpanan LPG dalam unit" }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Alokasi Bulanan (Opsional)" }),
              /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                Input,
                {
                  placeholder: "Contoh: 500",
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Jumlah alokasi tabung LPG (3kg) per bulan" }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              ...
              /* @__PURE__ */ jsx(FormDescription, { children: "Informasi tambahan tentang pangkalan" }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "pt-6 mt-6 border-t", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Key", className: "h-5 w-5 text-primary" }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold", children: "Akun Login Pangkalan" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Buat akun untuk login ke dashboard pangkalan. Email ini juga digunakan untuk invoice." }),
          /* @__PURE__ */ jsx(
            FormField,
            {
              control: form.control,
              name: "login_email",
              render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { className: "mb-4", children: [
                /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Email Login *" }),
                /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                  Input,
                  {
                ...
                /* @__PURE__ */ jsx(FormDescription, { children: "Email untuk login ke dashboard pangkalan" }),
                /* @__PURE__ */ jsx(FormMessage, {})
              ] })
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsx(
              FormField,
              {
                ...
                name: "login_password",
                render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                  /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Password *" }),
                  /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                    Input,
                    {
            ...
            /* @__PURE__ */ jsx(
              FormField,
              {
                ...
                render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                  /* @__PURE__ */ jsx(FormLabel, { className: "text-base font-semibold", children: "Konfirmasi Password *" }),
                  /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                    Input,
                    {
...
function PangkalanListPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-4 sm:p-6 lg:p-8 dashboard-gradient-bg min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 lg:grid-cols-3 gap-4", children: isLoading ? (
      ...
      /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "border-0 glass-card animate-fadeInUp h-full", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-xl bg-primary/10 dark:bg-primary/15", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Building2", className: "w-5 h-5 text-primary" }) }),
        ...
        /* @__PURE__ */ jsx(Tilt3DCard, { children: /* @__PURE__ */ jsx(Card, { className: "border-0 glass-card animate-fadeInUp h-full", style: { animationDelay: "0.2s" }, children: /* @__PURE__ */ jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-xl bg-rose-500/10 dark:bg-rose-500/15", children: /* @__PURE__ */ jsx(SafeIcon, { name: "XCircle", className: "w-5 h-5 text-rose-600 dark:text-rose-400" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Nonaktif" }),
            /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-rose-600 dark:text-rose-400", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: nonaktifCount, delay: 300 }) })
          ] })
        ] }) }) }) })
      ] })
    ) }),
    ...
    /* @__PURE__ */ jsx(Card, { className: "glass-card overflow-hidden", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-0", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3", children: [
        ...
        ] }, pangkalan.id)) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 10, className: "text-center py-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Search", className: "h-8 w-8 text-muted-foreground" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Tidak ada pangkalan ditemukan" })
        ] }) }) }) })
      ] }) }),
