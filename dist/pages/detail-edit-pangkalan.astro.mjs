...
import { S as SafeIcon, I as Input, B as Button, p as pangkalanApi, o as ordersApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
import { B as Badge, j as Skeleton, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, k as DialogFooter, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.DWDsm_1Q.js";
...
import { g as getKecamatanByKabupaten, F as Form, a as FormField, b as FormItem, c as FormLabel, d as FormControl, f as FormMessage, e as FormDescription, K as KABUPATEN_DATA } from "../_astro/regions.cq97tO2n.js";
import { f as formatCurrency, C as ConfirmationModal } from "../_astro/currency._AzJKMQz.js";
...
function DetailEditPangkalanContent() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-6 p-4 sm:p-6 lg:p-8", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { children: orders.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "overflow-auto max-h-[480px] border rounded-lg", children: /* @__PURE__ */ jsxs(Table, { children: [
            ...
            /* @__PURE__ */ jsx(TableBody, { children: orders.slice(0, 10).map((order) => /* @__PURE__ */ jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx("a", { href: `/detail-pesanan?id=${order.id}`, children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Eye", className: "h-4 w-4" }) }) }) })
            ] }, order.id)) })
          ] }) }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open: showResetPasswordModal, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "KeyRound", className: "h-5 w-5 text-amber-600" }),
          "Reset Password Akun Pangkalan"
        ] }),
        /* @__PURE__ */ jsx(DialogDescription, { children: newPassword ? "Password berhasil direset. Salin dan berikan ke pangkalan." : `Apakah Anda yakin ingin reset password untuk akun "${pangkalan?.users?.[0]?.email}"?` })
      ] }),
      newPassword ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-green-800 mb-2", children: "Password Baru:" }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsx(SafeIcon, { name: "Copy", className: "h-4 w-4" })
              }
            )
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-green-600 mt-2", children: "⚠️ Simpan password ini, tidak akan bisa dilihat lagi!" })
        ] }),
        /* @__PURE__ */ jsx(DialogFooter, { children: /* @__PURE__ */ jsx(Button, { onClick: () => {
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            children: isResettingPassword ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx(SafeIcon, { name: "KeyRound", className: "mr-2 h-4 w-4" }),
              "Reset Password"
            ] })
          }
        )
