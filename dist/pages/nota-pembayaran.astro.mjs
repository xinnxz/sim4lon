...
function NotaPembayaranPage() {
  ...
  const handlePrint = () => {
    ...
    const docNumber2 = isNota2 ? `NOTA-${data.orderCode.replace("ORD-", "")}` : `INV-${data.orderCode.replace("ORD-", "")}`;
    const originalTitle = document.title;
    document.title = `${isNota2 ? "Nota" : "Invoice"}_${docNumber2}_${data.customerName.replace(/\s+/g, "_")}`;
    setTimeout(() => {
      window.print();
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "p-8 print:p-6 relative", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "border dark:border-border/50 rounded-lg overflow-hidden mb-8 shadow-sm", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { children: data.items.map((item, index) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "border-t dark:border-border/50 hover:bg-muted/30 transition-colors", children: [
                /* @__PURE__ */ jsx("td", { className: "p-3 text-sm", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  imgSrc && /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center overflow-hidden shrink-0 print:bg-gray-100", children: /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: imgSrc,
                      alt: item.name,
          ...
          isNota && data.paymentProofUrl && /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-6 border-t dark:border-border/50 print:hidden", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-muted-foreground mb-3", children: "Bukti Transfer:" }),
            data.paymentProofUrl.endsWith(".pdf") ? /* @__PURE__ */ jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(SafeIcon, { name: "FileText", className: "h-5 w-5 text-red-600" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: "Lihat Bukti Transfer (PDF)" }),
                  /* @__PURE__ */ jsx(SafeIcon, { name: "ExternalLink", className: "h-4 w-4 text-muted-foreground" })
                ]
              }
            ) : /* @__PURE__ */ jsx(
              "a",
