...
import { C as Card, b as CardHeader, a as CardContent, d as CardTitle, e as CardDescription } from "../_astro/card.CnUj7wdc.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "../_astro/tabs.DCLuprNz.js";
import { S as SafeIcon, B as Button, I as Input, r as reportsApi } from "../_astro/AuthGuard.BLl0uVB7.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "../_astro/select.B8lpUjZQ.js";
import { B as Badge, j as Skeleton, e as DropdownMenu, f as DropdownMenuTrigger, g as DropdownMenuContent, h as DropdownMenuItem, P as ProtectedDashboard } from "../_astro/ProtectedDashboard.igvMWLOj.js";
...
import { f as formatCurrencyExport, c as createFooterRow, e as exportToPDF, a as exportToExcel, b as formatDateExport } from "../_astro/export-utils.DDLmg-WW.js";
...
function PangkalanTabContent({ dateRange, isLoading: initialLoading, onSummaryLoad, exportRef }) {
  ...
  const kecamatanList = useMemo(() => {
    ...
    const kecamatanSet = /* @__PURE__ */ new Set();
  ...
  const handleExportPDF = async () => {
    try {
      ...
      const columns = [
        ...
        { header: "Transaksi", key: "transactions", width: 10, align: "center" },
        { header: "Tabung", key: "tabung", width: 10, align: "center" },
  ...
  const handleExportAllPDF = async () => {
    ...
    try {
      ...
      const period = getPeriodLabel();
      const filename = `laporan-pangkalan-all-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}`;
      const columns = [
        { header: "No.", key: "no", width: 6, align: "center" },
        { header: "Kode", key: "code", width: 10 },
        { header: "Pangkalan", key: "name", width: 20 },
        { header: "Wilayah", key: "region", width: 20 },
        { header: "Subsidi", key: "tabung_subsidi", width: 10, align: "center" },
        { header: "Non-Subsidi", key: "tabung_nonsubsidi", width: 10, align: "center" },
        { header: "Total", key: "tabung_total", width: 8, align: "center" },
        { header: "Pendapatan", key: "revenue", width: 16, align: "right" }
      ];
  ...
  const handleExportConsumerPDF = async () => {
    ...
    try {
      ...
      const period = getPeriodLabel();
      const filename = `audit-konsumen-${consumersData.summary.pangkalan_code}-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}`;
      const columns = [
        { header: "No.", key: "no", width: 6, align: "center" },
        ...
        { header: "Pembelian", key: "purchases", width: 10, align: "center" },
        { header: "Tabung", key: "tabung", width: 8, align: "center" },
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 sm:space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden animate-slideInBlur stagger-1 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Pangkalan" }),
            /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-3xl font-bold text-primary mt-1 sm:mt-2", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_pangkalan || 0, delay: 100 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5 sm:mt-1", children: "Pangkalan aktif" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-emerald-100 to-green-200 dark:from-emerald-900/30 dark:to-green-800/30", style: { boxShadow: "0 4px 12px -2px hsl(152 100% 30% / 0.3)" }, children: /* @__PURE__ */ jsx(SafeIcon, { name: "Store", className: "h-4 w-4 sm:h-5 sm:w-5 text-primary" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-emerald-300 via-primary to-emerald-300" })
      ] }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden animate-slideInBlur stagger-2 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Transaksi" }),
            /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-3xl font-bold text-teal-600 dark:text-teal-400 mt-1 sm:mt-2", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_all_orders || 0, delay: 200 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5 sm:mt-1", children: "Semua tipe LPG" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900/30 dark:to-teal-800/30", style: { boxShadow: "0 4px 12px -2px rgba(20,184,166,0.3)" }, children: /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingCart", className: "h-4 w-4 sm:h-5 sm:w-5 text-teal-600 dark:text-teal-400" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-teal-300 via-teal-500 to-teal-300" })
      ] }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden animate-slideInBlur stagger-3 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Tabung" }),
            /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-1 sm:mt-2", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_all_tabung || 0, delay: 300 }) }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5 sm:mt-1 hidden sm:block", children: "Keseluruhan jenis tabung" }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 sm:hidden", children: "Semua jenis" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900/30 dark:to-emerald-800/30", style: { boxShadow: "0 4px 12px -2px rgba(16,185,129,0.3)" }, children: /* @__PURE__ */ jsx(SafeIcon, { name: "Boxes", className: "h-4 w-4 sm:h-5 sm:w-5 text-emerald-600 dark:text-emerald-400" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-emerald-300 via-emerald-500 to-emerald-300" })
      ] }) }),
      /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden animate-slideInBlur stagger-4 card-hover-glow", children: /* @__PURE__ */ jsxs("div", { className: "p-3 sm:p-5 relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Pendapatan" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1 sm:mt-2", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_all_revenue || 0, delay: 400, isCurrency: true }) }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5 sm:mt-1 hidden sm:block", children: "Revenue keseluruhan" }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 sm:hidden", children: "Revenue total" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-amber-100 to-yellow-200 dark:from-amber-900/30 dark:to-yellow-800/30", style: { boxShadow: "0 4px 12px -2px hsl(48 100% 50% / 0.3)" }, children: /* @__PURE__ */ jsx(SafeIcon, { name: "Wallet", className: "h-4 w-4 sm:h-5 sm:w-5 text-amber-600 dark:text-amber-400" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-amber-300 via-yellow-500 to-amber-300" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2 min-w-max", children: [
      /* @__PURE__ */ jsxs(
        Button,
        {
          variant: activeSubTab === "subsidi" ? "default" : "outline",
          size: "sm",
          className: `h-8 sm:h-10 text-xs sm:text-sm ${activeSubTab === "subsidi" ? "bg-gradient-to-r from-green-600 to-emerald-600 text-white border-0 shadow-lg" : "hover:bg-green-50 dark:hover:bg-green-900/20"}`,
          onClick: () => handleSubTabChange("subsidi"),
          children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Shield", className: "w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" }),
            /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "LPG Subsidi (3kg)" }),
            /* @__PURE__ */ jsx("span", { className: "sm:hidden", children: "Subsidi 3kg" }),
            /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "ml-1.5 sm:ml-2 bg-white/20 text-inherit text-[10px] sm:text-xs", children: pangkalanData?.summary.total_tabung_subsidi || 0 })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        Button,
        {
          ...
          size: "sm",
          className: `h-8 sm:h-10 text-xs sm:text-sm ${activeSubTab === "nonsubsidi" ? "bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 shadow-lg" : "hover:bg-amber-50 dark:hover:bg-amber-900/20"}`,
          onClick: () => handleSubTabChange("nonsubsidi"),
          children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" }),
            /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "LPG Non-Subsidi" }),
            /* @__PURE__ */ jsx("span", { className: "sm:hidden", children: "Non-Subsidi" }),
            /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "ml-1.5 sm:ml-2 bg-white/20 text-inherit text-[10px] sm:text-xs", children: pangkalanData?.summary.total_nonsubsidi_tabung || 0 })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "flex items-center flex-wrap gap-2", children: /* @__PURE__ */ jsxs(Badge, { variant: "outline", className: "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-700 text-xs", children: [
      /* @__PURE__ */ jsx(SafeIcon, { name: "Calendar", className: "h-3 w-3 mr-1" }),
      "Periode: ",
      getPeriodLabel()
    ] }) }),
    isLoading ? /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl p-3 sm:p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-4 rounded" }),
        /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-40" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-5 gap-2 sm:gap-3", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg p-2 sm:p-3 text-center bg-muted/30", children: [
        /* @__PURE__ */ jsx(Skeleton, { className: "h-8 w-8 sm:h-10 sm:w-10 mx-auto mb-1 rounded-lg" }),
        /* @__PURE__ */ jsx(Skeleton, { className: "h-6 w-12 mx-auto mb-1" }),
        /* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-8 mx-auto" })
      ] }, i)) })
    ] }) : pangkalanData?.summary.tabung_by_type && /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl p-3 sm:p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx(SafeIcon, { name: "Package", className: "h-4 w-4 text-primary" }),
        /* @__PURE__ */ jsx("span", { className: "text-xs sm:text-sm font-semibold text-muted-foreground", children: "Breakdown Tabung per Jenis" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-5 gap-2 sm:gap-3", children: [
      ...
      ].map((item, index) => /* @__PURE__ */ jsxs("div", { className: `rounded-lg p-2 sm:p-3 text-center ${item.color}`, children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: item.image,
        ...
        /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-foreground", children: /* @__PURE__ */ jsx(AnimatedNumber, { value: item.value, delay: index * 100 }) }),
        /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground", children: item.label })
      ] }, item.label)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      isLoading ? /* @__PURE__ */ jsxs(Card, { className: "glass-card rounded-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-2 border-b border-border/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Skeleton, { className: "w-2 h-2 rounded-full" }),
            /* @__PURE__ */ jsx(Skeleton, { className: "h-5 w-40" }),
            /* @__PURE__ */ jsx(Skeleton, { className: "ml-auto h-5 w-16 rounded-full" })
          ] }),
          /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-56 mt-1" })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { className: "p-3 sm:p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "h-[220px] sm:h-[280px] flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Skeleton, { className: "w-32 h-32 sm:w-40 sm:h-40 rounded-full" }),
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "w-16 h-16 sm:w-20 sm:h-20 bg-background rounded-full" }) })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-2 mt-2", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx(Skeleton, { className: "w-3 h-3 rounded" }),
            /* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-12" })
          ] }, i)) })
        ] })
      ] }) : wilayahDistribution.length > 0 && /* @__PURE__ */ jsxs(Card, { className: "glass-card rounded-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-2 border-b border-border/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-primary animate-pulse" }),
            /* @__PURE__ */ jsx(CardTitle, { className: "text-base sm:text-lg font-semibold", children: "Distribusi per Kecamatan" }),
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "ml-auto text-[10px] sm:text-xs", children: activeSubTab === "subsidi" ? "Subsidi" : "Non-Subsidi" })
          ] }),
          /* @__PURE__ */ jsx(CardDescription, { className: "text-xs sm:text-sm", children: "Distribusi tabung berdasarkan kecamatan" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsx("div", { className: "h-[220px] sm:h-[280px]", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
          /* @__PURE__ */ jsx(
            Pie,
            {
              ...
              labelLine: true,
              fontSize: 10,
              children: wilayahDistribution.map((_, index) => /* @__PURE__ */ jsx(Cell, { fill: PIE_COLORS[index % PIE_COLORS.length] }, `cell-${index}`))
            }
          ),
          /* @__PURE__ */ jsx(
            Tooltip,
            {
              formatter: (value, name) => [value.toLocaleString("id-ID") + " Tabung", name],
          ...
          /* @__PURE__ */ jsx(
            Legend,
            {
              ...
              height: 36,
              formatter: (value) => /* @__PURE__ */ jsx("span", { className: "text-[10px] sm:text-xs", children: value })
            }
          )
        ] }) }) }) })
      ] }),
      isLoading ? /* @__PURE__ */ jsxs(Card, { className: "glass-card rounded-2xl overflow-hidden h-full", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-2 border-b border-border/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Skeleton, { className: "w-2 h-2 rounded-full" }),
          ...
          /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-48 mt-1" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsx("div", { className: "grid gap-3 sm:gap-4 grid-cols-2", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-16 mb-2" }),
              /* @__PURE__ */ jsx(Skeleton, { className: "h-7 w-20 mb-1" }),
              /* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-12" })
            ] }),
            /* @__PURE__ */ jsx(Skeleton, { className: "h-10 w-10 rounded-lg" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-muted/30" })
        ] }, i)) }) })
      ] }) : activeSubTab === "subsidi" ? /* @__PURE__ */ jsxs(Card, { className: "glass-card rounded-2xl overflow-hidden h-full", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-2 border-b border-border/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-green-500 animate-pulse" }),
            /* @__PURE__ */ jsx(CardTitle, { className: "text-base sm:text-lg font-semibold", children: "Distribusi Subsidi (3kg)" }),
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "ml-auto bg-green-50 text-green-700 border-green-200 text-[10px] sm:text-xs dark:bg-green-900/30 dark:text-green-400 dark:border-green-700", children: "Audit Focus" })
          ] }),
          /* @__PURE__ */ jsx(CardDescription, { className: "text-xs sm:text-sm", children: "Ringkasan penyaluran LPG subsidi 3kg" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:gap-4 grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Transaksi" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl font-bold text-green-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_orders_subsidi || 0, delay: 100 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Transaksi 3kg" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/30 dark:to-green-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingBag", className: "h-4 w-4 sm:h-5 sm:w-5 text-green-600 dark:text-green-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-300 via-green-500 to-green-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Tabung" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl font-bold text-teal-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_tabung_subsidi || 0, delay: 200 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Terdistribusi" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900/30 dark:to-teal-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Package", className: "h-4 w-4 sm:h-5 sm:w-5 text-teal-600 dark:text-teal-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-teal-300 via-teal-500 to-teal-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Pendapatan" }),
                /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-lime-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_revenue_subsidi || 0, delay: 300, isCurrency: true }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Revenue 3kg" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-lime-100 to-lime-200 dark:from-lime-900/30 dark:to-lime-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "CircleDollarSign", className: "h-4 w-4 sm:h-5 sm:w-5 text-lime-600 dark:text-lime-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-lime-300 via-lime-500 to-lime-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Konsumen" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl font-bold text-purple-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.active_consumers || 0, delay: 400 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Pembeli subsidi" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Users", className: "h-4 w-4 sm:h-5 sm:w-5 text-purple-600 dark:text-purple-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-300 via-purple-500 to-purple-300" })
          ] })
        ] }) })
      ] }) : /* @__PURE__ */ jsxs(Card, { className: "glass-card rounded-2xl overflow-hidden h-full", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-2 border-b border-border/50", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-amber-500 animate-pulse" }),
            /* @__PURE__ */ jsx(CardTitle, { className: "text-base sm:text-lg font-semibold", children: "LPG Non-Subsidi" }),
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "ml-auto bg-amber-50 text-amber-700 border-amber-200 text-[10px] sm:text-xs dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-700", children: "Business" })
          ] }),
          /* @__PURE__ */ jsx(CardDescription, { className: "text-xs sm:text-sm", children: "Ringkasan penjualan LPG non-subsidi" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:gap-4 grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Transaksi" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl font-bold text-amber-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_nonsubsidi_orders || 0, delay: 100 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Non-Subsidi" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-900/30 dark:to-amber-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingBag", className: "h-4 w-4 sm:h-5 sm:w-5 text-amber-600 dark:text-amber-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-amber-300 via-amber-500 to-amber-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Tabung" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl sm:text-2xl font-bold text-orange-600 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_nonsubsidi_tabung || 0, delay: 200 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Terjual" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Flame", className: "h-4 w-4 sm:h-5 sm:w-5 text-orange-600 dark:text-orange-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-orange-300 via-orange-500 to-orange-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Pendapatan" }),
                /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-yellow-600 dark:text-yellow-400 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: pangkalanData?.summary.total_nonsubsidi_revenue || 0, delay: 300, isCurrency: true }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Revenue" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-yellow-900/30 dark:to-yellow-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "CircleDollarSign", className: "h-4 w-4 sm:h-5 sm:w-5 text-yellow-600 dark:text-yellow-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-yellow-300 via-yellow-500 to-yellow-300" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl sm:rounded-2xl overflow-hidden p-3 sm:p-4 relative", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Top Pangkalan" }),
                /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl font-bold text-red-600 mt-1 truncate max-w-[100px]", children: isLoading ? "..." : filteredData[0]?.name?.split(" ").slice(0, 2).join(" ") || "-" }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] sm:text-xs text-muted-foreground mt-0.5", children: "Terbanyak" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 sm:p-3 rounded-lg bg-gradient-to-br from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-800/30", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Award", className: "h-4 w-4 sm:h-5 sm:w-5 text-red-600 dark:text-red-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-red-300 via-red-500 to-red-300" })
          ] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Card, { className: "glass-card", children: /* @__PURE__ */ jsx(CardContent, { className: "p-3 sm:p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 sm:gap-4 items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-[120px] sm:min-w-[200px]", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsx(SafeIcon, { name: "Search", className: "absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground" }),
        /* @__PURE__ */ jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 sm:gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-xs sm:text-sm text-muted-foreground whitespace-nowrap hidden sm:inline", children: "Kecamatan:" }),
        /* @__PURE__ */ jsxs(Select, { value: regionFilter, onValueChange: (v) => {
          setRegionFilter(v);
          setPangkalanCurrentPage(1);
        }, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[100px] sm:w-[140px] h-8 sm:h-10 text-xs sm:text-sm", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsx(SelectItem, { value: "ALL", children: "Semua" }),
            kecamatanList.map((r) => /* @__PURE__ */ jsx(SelectItem, { value: r, children: r }, r))
          ] })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Download", className: "h-3.5 w-3.5" }),
              /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Export" }),
              /* @__PURE__ */ jsx(SafeIcon, { name: "ChevronDown", className: "h-3 w-3" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", className: "w-40", children: [
          /* @__PURE__ */ jsxs(DropdownMenuItem, { onClick: handleExportPDF, className: "cursor-pointer", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "FileText", className: "h-4 w-4 mr-2 text-red-500" }),
          ...
          /* @__PURE__ */ jsxs(DropdownMenuItem, { onClick: handleExportExcel, className: "cursor-pointer", children: [
            /* @__PURE__ */ jsx(SafeIcon, { name: "FileSpreadsheet", className: "h-4 w-4 mr-2 text-green-500" }),
      ...
      /* @__PURE__ */ jsx(CardHeader, { className: "pb-3 border-b border-border/50", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxs(Select, { value: selectedPangkalanId, onValueChange: handlePangkalanSelect, children: [
            /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[180px] sm:w-[200px]", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Pilih pangkalan..." }) }),
            /* @__PURE__ */ jsx(SelectContent, { children: pangkalanData?.data.map((p) => /* @__PURE__ */ jsx(SelectItem, { value: p.id, children: p.name }, p.id)) })
          ] }),
          consumersData?.data?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxs(
              Button,
              {
                variant: "outline",
                ...
                children: [
                  /* @__PURE__ */ jsx(SafeIcon, { name: "FileText", className: "h-3.5 w-3.5 mr-1" }),
                  "PDF"
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(SafeIcon, { name: "FileSpreadsheet", className: "h-3.5 w-3.5 mr-1" }),
                  "Excel"
                ]
              }
            )
...
function ReportsPage() {
  ...
  const pangkalanExportRef = useRef(null);
  ...
  const PIE_COLORS2 = ["#22c55e", "#f59e0b", "#3b82f6", "#ef4444", "#8b5cf6", "#06b6d4"];
    ...
    try {
      ...
      if (activeTab === "sales" && salesData) {
        const columns = [
          ...
          { header: "Pendapatan", key: "total", width: 14, align: "right" },
          { header: "Modal", key: "cost", width: 14, align: "right" },
          { header: "Profit", key: "profit", width: 14, align: "right" },
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-3 sm:space-y-6", children: [
    /* @__PURE__ */ jsx("div", { className: "glass-card rounded-xl sm:rounded-2xl p-3 sm:p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 sm:gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-muted/50", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Calendar", className: "h-3.5 w-3.5 text-muted-foreground" }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-foreground", children: "Periode" })
        ] }),
        /* @__PURE__ */ jsxs(Select, { value: datePreset, onValueChange: handlePresetChange, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[130px] sm:w-[180px] h-8 text-xs sm:text-sm bg-background border-border/50 hover:border-primary/50 transition-colors", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Pilih periode" }) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
        ...
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsx(DropdownMenuContent, { align: "end", className: "w-44", children: activeTab === "pangkalan" ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs(
              DropdownMenuItem,
              {
      ...
      datePreset === "custom" && /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-center flex-wrap bg-muted/30 p-2 rounded-lg border border-border/50", children: [
        /* @__PURE__ */ jsx(
          Input,
          {
            type: "date",
        ...
        /* @__PURE__ */ jsx(SafeIcon, { name: "ArrowRight", className: "h-3 w-3 text-muted-foreground" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            type: "date",
        ...
        /* @__PURE__ */ jsxs(Button, { size: "sm", onClick: handleCustomDateApply, className: "h-8 text-xs", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Check", className: "h-3 w-3 mr-1" }),
          "OK"
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs(Tabs, { value: activeTab, onValueChange: handleTabChange, className: "space-y-3 sm:space-y-4", children: [
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0", children: /* @__PURE__ */ jsxs(TabsList, { className: "inline-flex h-auto gap-1 rounded-xl sm:rounded-2xl glass-card p-1.5 sm:p-2 shadow-lg min-w-max mb-2", children: [
        /* @__PURE__ */ jsxs(
          TabsTrigger,
          {
            value: "sales",
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingCart", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
              /* @__PURE__ */ jsx("span", { children: "Penjualan" }),
              salesData && salesData.summary.total_orders > 0 && /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: `ml-0.5 h-4 sm:h-5 min-w-4 sm:min-w-5 rounded-full px-1 sm:px-1.5 text-[10px] sm:text-xs font-medium ${activeTab === "sales" ? "bg-white/20 text-white" : "bg-primary/10 text-primary"}`, children: salesData.summary.total_orders })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Store", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
              /* @__PURE__ */ jsx("span", { children: "Pangkalan" }),
              totalPangkalan > 0 && /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: `ml-0.5 h-4 sm:h-5 min-w-4 sm:min-w-5 rounded-full px-1 sm:px-1.5 text-[10px] sm:text-xs font-medium ${activeTab === "pangkalan" ? "bg-white/20 text-white" : "bg-accent/10 text-accent"}`, children: totalPangkalan })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SafeIcon, { name: "Package", className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }),
              /* @__PURE__ */ jsx("span", { children: "Stok" }),
              stockData && stockData.summary.current_balance !== void 0 && /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: `ml-0.5 h-4 sm:h-5 min-w-4 sm:min-w-5 rounded-full px-1 sm:px-1.5 text-[10px] sm:text-xs font-medium ${activeTab === "stock" ? "bg-white/20 text-white" : "bg-amber-500/10 text-amber-600"}`, children: stockData.summary.current_balance })
            ]
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxs(TabsContent, { value: "sales", className: "space-y-3 sm:space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-5", children: [
          /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-1 card-hover-glow h-[120px]", children: /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-full flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Pesanan" }),
                /* @__PURE__ */ jsx("p", { className: "text-2xl lg:text-3xl font-bold text-primary mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: salesData?.summary.total_orders || 0, delay: 100 }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: "Pesanan periode ini" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 rounded-xl bg-gradient-to-br from-primary/20 to-emerald-200/50 dark:from-primary/30 dark:to-emerald-800/30 shadow-lg flex-shrink-0", children: /* @__PURE__ */ jsx(SafeIcon, { name: "ShoppingCart", className: "h-4 w-4 text-primary" }) })
            ] }),
          ...
          /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-2 card-hover-glow h-[120px]", children: /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-full flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Total Pendapatan" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl lg:text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: salesData?.summary.total_revenue || 0, delay: 200, isCurrency: true }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: "Revenue bruto" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 rounded-xl bg-gradient-to-br from-emerald-100 to-green-200 dark:from-emerald-900/30 dark:to-green-800/30 shadow-lg flex-shrink-0", children: /* @__PURE__ */ jsx(SafeIcon, { name: "TrendingUp", className: "h-4 w-4 text-emerald-600 dark:text-emerald-400" }) })
            ] }),
          ...
          /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-3 card-hover-glow h-[120px]", children: /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-full flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Profit Bersih" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl lg:text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: salesData?.summary?.total_profit || 0, delay: 250, isCurrency: true }) }),
                /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: [
                  "Margin: ",
                  isLoading ? "..." : `${(salesData?.summary?.profit_margin || 0).toFixed(1)}%`
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 shadow-lg flex-shrink-0", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Coins", className: "h-4 w-4 text-blue-600 dark:text-blue-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-300 via-blue-500 to-blue-300" })
          ] }) }),
          /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-4 card-hover-glow h-[120px]", children: /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-full flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Rata-rata Pesanan" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl lg:text-2xl font-bold text-teal-600 dark:text-teal-400 mt-1", children: isLoading ? "..." : /* @__PURE__ */ jsx(AnimatedNumber, { value: salesData?.summary.average_order || 0, delay: 300, isCurrency: true }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: "Per transaksi" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "p-2 rounded-xl bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900/30 dark:to-teal-800/30 shadow-lg flex-shrink-0", children: /* @__PURE__ */ jsx(SafeIcon, { name: "Calculator", className: "h-4 w-4 text-teal-600 dark:text-teal-400" }) })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-300 via-teal-500 to-teal-300" })
          ] }) }),
          /* @__PURE__ */ jsx(Tilt3DCard, { className: "glass-card rounded-2xl overflow-hidden animate-slideInBlur stagger-5 card-hover-glow col-span-2 md:col-span-1 h-[120px]", children: /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-full flex flex-col justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", children: "Pertumbuhan" }),
                /* @__PURE__ */ jsx("p", { className: `text-2xl lg:text-3xl font-bold mt-1 ${growthPercentage >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`, children: isLoading ? "..." : `${growthPercentage >= 0 ? "+" : ""}${growthPercentage.toFixed(1)}%` }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: "Vs target harian" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: `p-2 rounded-xl shadow-lg flex-shrink-0 bg-gradient-to-br ${growthPercentage >= 0 ? "from-green-100 to-green-200 dark:from-green-900/30 dark:to-green-800/30" : "from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-800/30"}`, children: /* @__PURE__ */ jsx(SafeIcon, { name: growthPercentage >= 0 ? "TrendingUp" : "TrendingDown", className: `h-4 w-4 ${growthPercentage >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}` }) })
            ] }),
              ...
              /* @__PURE__ */ jsx(
                Pie,
                {
                  ...
                  children: salesByStatusData.map((_, index) => /* @__PURE__ */ jsx(
                    Cell,
                    {
                      fill: PIE_COLORS2[index % PIE_COLORS2.length],
                      stroke: "#fff",
                      strokeWidth: 2
                    },
                    `cell-${index}`
