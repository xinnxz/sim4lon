...
import { S as SafeIcon, B as Button, o as ordersApi, a as paymentApi } from "../_astro/AuthGuard.Cq_0lvUi.js";
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
    ...
    paymentMethod === "transfer" && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "border-2 border-dashed rounded-lg p-4 text-center hover:bg-secondary/50 transition-colors", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "transferProof",
          ...
          /* @__PURE__ */ jsx("label", { htmlFor: "transferProof", className: isPaymentSuccessful ? "cursor-not-allowed block" : "cursor-pointer block", children: transferProof ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: transferProof.name })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Klik untuk ganti file" })
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "Klik untuk unggah bukti transfer" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "JPG, PNG, atau PDF (Max 5MB)" })
            ] })
          ] }) })
        ] }),
      ...
      showPreviewModal && imagePreview && /* @__PURE__ */ jsx(
        "div",
        {
          className: "fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4",
          onClick: () => setShowPreviewModal(false),
          children: /* @__PURE__ */ jsxs("div", { className: "relative max-w-3xl max-h-[90vh]", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: imagePreview,
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      const paymentDto = {
        ...
        proof_url: data.transferProof ? `uploaded/${data.transferProof.name}` : void 0,
