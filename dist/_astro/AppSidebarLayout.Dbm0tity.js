...
import { p as Sidebar, q as SidebarContent, r as SidebarGroup, s as SidebarGroupLabel, t as SidebarGroupContent, u as SidebarMenu, v as SidebarMenuItem, F as SidebarMenuButton, B as Badge, C as SidebarProvider, E as SidebarInset } from "./ProtectedDashboard.DfQvqnI6.js";
import { useState, useEffect, useRef, useCallback } from "react";
import { k as companyProfileApi, S as SafeIcon, B as Button } from "./AuthGuard.D1AOouTt.js";
...
function useVoiceOrder() {
  ...
  return {
    ...
    // Use liveTranscript for real-time display
    parseResult,
    error,
    missingInfo,
    missingInfoPrompt,
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-5 max-h-[60vh] overflow-y-auto", children: [
            ...
            status === "error" && /* @__PURE__ */ jsx("div", { className: "p-4 rounded-xl bg-red-50 dark:bg-red-900/20", children: parseResult?.validation && !parseResult.validation.isValid ? /* @__PURE__ */ jsx("div", { className: "space-y-2", children: parseResult.validation.issues.map((issue, i) => /* @__PURE__ */ jsxs("div", { children: [
            ...
            status === "success" && /* @__PURE__ */ jsxs("div", { className: "py-8 text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "font-semibold text-green-600", children: "Pesanan Dibuat!" })
            ] })
          ] }),
