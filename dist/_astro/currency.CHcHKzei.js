...
import { n as notificationApi, S as SafeIcon, B as Button, m as agenPangkalanOrdersApi, f as authApi, j as clearCachedProfile, h as removeToken } from "./AuthGuard.71S_I7hh.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, B as Badge, e as DropdownMenu, f as DropdownMenuTrigger, A as Avatar, l as AvatarImage, k as AvatarFallback, g as DropdownMenuContent, x as DropdownMenuLabel, y as DropdownMenuSeparator, h as DropdownMenuItem, z as useSidebar } from "./ProtectedDashboard.TvdlGC6x.js";
import * as ScrollAreaPrimitive from "@radix-ui/react-scroll-area";
import { c as cn } from "./card.CnUj7wdc.js";
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-md p-0 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "p-4 border-t border-border/50 bg-muted/30", children: /* @__PURE__ */ jsx(
      Button,
      {
        ...
        asChild: true,
        children: /* @__PURE__ */ jsxs("a", { href: "/notifikasi", children: [
          /* @__PURE__ */ jsx(SafeIcon, { name: "Bell", className: "h-4 w-4" }),
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { notificationApi: notificationApi2 } = await import("./AuthGuard.71S_I7hh.js").then((n) => n.D);
        const notifData = await notificationApi2.getNotifications(1, 20);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-50 w-full border-b border-border bg-gradient-to-r from-background to-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-lg transition-all duration-300", id: "ijli", children: /* @__PURE__ */ jsxs("div", { className: "w-full flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("a", { href: "/dashboard", className: "cursor-pointer hover:opacity-80 transition-opacity duration-200", children: [
          /* @__PURE__ */ jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", className: "w-56 p-2", children: [
            ...
            /* @__PURE__ */ jsx(DropdownMenuItem, { asChild: true, className: "rounded-lg cursor-pointer", children: /* @__PURE__ */ jsxs("a", { href: "/profil", className: "flex items-center gap-2 px-2 py-2", children: [
