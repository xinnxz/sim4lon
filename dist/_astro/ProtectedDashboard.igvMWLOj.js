...
import { X, PanelLeft, ChevronRight, Check, Circle } from "lucide-react";
import { c as cn } from "./card.CnUj7wdc.js";
import { B as Button, I as Input, C as AuthGuard } from "./AuthGuard.BLl0uVB7.js";
...
const SheetContent = React.forwardRef(({ side = "right", className, children, hideCloseButton, ...props }, ref) => /* @__PURE__ */ jsxs(SheetPortal, { children: [
  ...
  /* @__PURE__ */ jsxs(
    DialogPrimitive.Content,
    {
      ...
      ...props,
      children: [
        !hideCloseButton && /* @__PURE__ */ jsxs(DialogPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary z-50", children: [
...
const DialogContentNoScrollLock = React.forwardRef(({ className, children, onOverlayClick, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal, { children: [
  /* @__PURE__ */ jsx(
    "div",
    {
...
DialogContentNoScrollLock.displayName = "DialogContentNoScrollLock";
const DialogHeader = ({
  className,
  ...props
}) => /* @__PURE__ */ jsx(
...
export {
  Avatar as A,
  Badge as B,
  SidebarProvider as C,
  Dialog as D,
  SidebarInset as E,
  SidebarMenuButton as F,
  ...
  SidebarContent as q,
  SidebarGroup as r,
  SidebarGroupLabel as s,
  SidebarGroupContent as t,
  SidebarMenu as u,
  SidebarMenuItem as v,
  SidebarFooter as w,
  DropdownMenuLabel as x,
