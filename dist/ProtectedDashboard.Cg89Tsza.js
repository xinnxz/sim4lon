...
function AdminHeader({
  ...
  const [avatarUrl, setAvatarUrl] = useState(void 0);
        ...
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { variant: "ghost", className: "flex items-center gap-2 px-2", children: [
            /* @__PURE__ */ jsxs(Avatar, { className: "h-8 w-8", children: [
              /* @__PURE__ */ jsx(AvatarImage, { src: avatarUrl, alt: userName }),
              /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-primary text-primary-foreground", children: userName.split(" ").map((n) => n[0]).join("").toUpperCase().slice(0, 2) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "hidden md:block text-left", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: userName }),
