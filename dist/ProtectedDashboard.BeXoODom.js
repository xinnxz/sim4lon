...
import { n as notificationApi, S as SafeIcon, B as Button, e as authApi, j as clearCachedProfile, h as removeToken, A as AuthGuard } from "./AuthGuard.C-gox2l6.js";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { notificationApi: notificationApi2 } = await import("./AuthGuard.C-gox2l6.js").then((n) => n.k);
