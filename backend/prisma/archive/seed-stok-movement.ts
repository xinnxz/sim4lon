/**
 * SEED: Stock Movement Data untuk Laporan Tab Stok
 * 
 * Creates realistic stock movement data:
 * 1. MASUK - Penerimaan dari SPBE (daily entries)
 * 2. KELUAR - Penyaluran ke pangkalan (from orders)
 * 
 * Target: 30+ pergerakan stok untuk grafik yang bagus
 * 
 * CARA PAKAI:
 * cd backend
 * npx ts-node prisma/seed-stok-movement.ts
 */
...
async function main() {
    ...
    // ============================================
    // CLEANUP: Delete previous seed movements
    // ============================================
    ...
    // ============================================
    // 1. INITIAL STOCK (big MASUK at month start)
    // ============================================
    ...
    // ============================================
    // 2. DAILY PENERIMAAN (MASUK) - from SPBE
    // ============================================
    ...
    for (let day = 1; day <= daysToSeed; day++) {
        ...
        // 70% chance of penerimaan on weekdays
        if (Math.random() > 0.7) continue;

        // Random time 06:00-10:00
        date.setHours(6 + Math.floor(Math.random() * 4));
        date.setMinutes(Math.floor(Math.random() * 60));

        // Qty: 200-500 tabung per penerimaan
    ...
    // ============================================
    // 3. DAILY PENYALURAN (KELUAR) - to pangkalan
    // ============================================
    ...
    for (let day = 1; day <= daysToSeed; day++) {
        ...
        for (let i = 0; i < numPenyaluran; i++) {
            ...
            // Qty: 20-80 tabung per penyaluran
