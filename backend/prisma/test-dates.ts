// Test script to verify date day-of-week detection
// Run with: npx ts-node prisma/test-dates.ts
...
async function main() {
    ...
    for (const t of testDates) {
        const date = new Date(2025, 11, t.day, 12, 0, 0); // December = month 11 (0-indexed)
    ...
    // Check existing data for Sundays
