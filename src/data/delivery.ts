 ...
 */
export interface DeliveryListItemModel extends Pick<
  DeliveryDetailModel,
  "deliveryId" | "currentStatus" | "tanggalJadwal" | "orderId"
> {
  pangkalan: PangkalanSummary;
  driverName: string;
...
const MOCK_DELIVERY_DATA: DeliveryDetailModel[] = [
  {
    ...
    driver: {
      userId: mockDriver1!.userId,
      nama: mockDriver1!.nama,
      telepon: mockDriver1!.telepon,
      avatarUrl: mockDriver1!.avatarUrl,
    },
    ...
    timeline: [
      {
        status: "Pengiriman Dijadwalkan" as any,
        deskripsi: "Jadwal dibuat pada 2 Desember 2025",
        tanggal: "2025-12-02T08:00:00Z",
        iconName: "CalendarCheck",
      },
      {
        status: "MENUNGGU_PICKUP",
        deskripsi: "Driver U-003 mempersiapkan barang di gudang.",
        tanggal: "2025-12-02T10:00:00Z",
        iconName: "HardHat",
      },
      {
        status: "DALAM_PERJALANAN",
        deskripsi: "Truck No. B 1234 XYZ berangkat menuju Pangkalan P-001.",
        tanggal: "2025-12-02T13:00:00Z",
        iconName: "Truck",
      },
      {
        status: "DELIVERED",
        deskripsi: "Barang diterima dan status pengiriman selesai.",
        tanggal: "2025-12-02T15:45:00Z",
        iconName: "MapPin",
      },
    ],
    proof: {
      photoUrl:
        "https://spark-builder.s3.us-east-1.amazonaws.com/image/2025/12/3/baea0813-5005-4cfe-8ad9-587aa2fa797c.png",
      receiverName: "Luthfi Alfaridz (Admin Pangkalan)",
  ...
  },
  {
    ...
    timeline: [
      {
        status: "Pengiriman Dijadwalkan" as any,
        deskripsi: "Jadwal dibuat untuk tanggal 4 Desember 2025",
        tanggal: "2025-12-03T15:00:00Z",
        iconName: "CalendarCheck",
      },
      {
        status: "MENUNGGU_PICKUP",
        deskripsi: "Menunggu driver untuk mengambil stok di gudang.",
        tanggal: "2025-12-03T15:05:00Z",
        iconName: "Box",
      },
    ],
    proof: undefined,
...
export const MOCK_DELIVERY_LIST: DeliveryListItemModel[] =
  MOCK_DELIVERY_DATA.map((d) => ({
