...
const mockInvoiceData = {
  ...
  notes:
    "Terima kasih atas kepercayaan Anda. Barang akan dikirim sesuai jadwal yang telah disepakati.",
  terms:
    "Pembayaran harus dilakukan sebelum pengiriman. Barang yang rusak dapat diklaim dalam 24 jam setelah pengiriman.",
};
